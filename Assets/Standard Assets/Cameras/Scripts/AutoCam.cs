...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        public bool followVelocity = false;// Whether the rig will rotate in the direction of the target's velocity.
        ...
        public float targetVelocityLowerLimit = 4f;// the minimum velocity above which the camera turns towards the object's velocity. Below this we use the object's forward direction.
        public float smoothTurnTime = 0.2f; // the smoothing for the camera's rotation
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            if (followVelocity && Application.isPlaying)
            {
                ...
                m_CurrentTurnAmount = Mathf.SmoothDamp(m_CurrentTurnAmount, 1, ref m_TurnSpeedVelocityChange, smoothTurnTime);
            }
            else
            {
            ...
            m_RollUp = rollSpeed > 0 ? Vector3.Slerp(m_RollUp, targetUp, rollSpeed*deltaTime) : Vector3.up;
